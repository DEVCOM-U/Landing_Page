...
<head>
    ...
    <title>Dashboard - DevCom_U Admin Dashboard</title>
  ...
  <link rel="stylesheet" crossorigin href="{{ asset("backend-assets/assets/compiled/css/app.css") }}">
  <link rel="stylesheet" crossorigin href="{{ asset("backend-assets/assets/compiled/css/app-dark.css") }}">
  <link rel="stylesheet" crossorigin href="{{ asset("backend-assets/assets/compiled/css/iconly.css") }}">
</head>

<body>
    <script src="{{ asset("backend-assets/assets/static/js/initTheme.js") }}"></script>
    <div id="app">
        <div id="sidebar">
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li class="sidebar-title">Edit Pages</li>
...
<div class="page-content"> 
                                    ...
                                    <tbody>
                                            ...
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <img src="{{ asset("backend-assets/") }}/assets/compiled/jpg/5.jpg">
                                                    </div>
                                        ...
                                        <tr>
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <img src="{{ asset("backend-assets/") }}/assets/compiled/jpg/2.jpg">
                                                    </div>
                                        ...
                                        <tr>
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <img src="{{ asset("backend-assets/") }}/assets/compiled/jpg/8.jpg">
                                                    </div>
                                        ...
                                        <tr>
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <img src="{{ asset("backend-assets/") }}/assets/compiled/jpg/3.jpg">
                                                    </div>
                ...
                <div class="card-body py-4 px-4">
                    <div class="d-flex align-items-center">
                        <div class="avatar avatar-xl">
                            <img src="{{ asset("backend-assets/") }}/assets/compiled/jpg/1.jpg" alt="Face 1">
                        </div>
                        <div class="ms-3 name">
                ...
                <div class="card-content pb-4">
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
                            <img src="{{ asset("backend-assets/") }}/assets/compiled/jpg/4.jpg">
                        </div>
                        <div class="name ms-4">
                    ...
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
                            <img src="{{ asset("backend-assets/") }}/assets/compiled/jpg/1.jpg">
                        </div>
                        <div class="name ms-4">
    ...
    <script src="{{ asset("backend-assets/assets/static/js/components/dark.js") }}"></script>
    <script src="{{ asset("backend-assets/assets/extensions/perfect-scrollbar/perfect-scrollbar.min.js") }}"></script>
    
    
    <script src="{{ asset("backend-assets/assets/compiled/js/app.js") }}"></script>
    

    
<!-- Need: Apexcharts -->
<script src="{{ asset("backend-assets/assets/assets/extensions/apexcharts/apexcharts.min.js") }}"></script>
<script src="{{ asset("backend-assets/assets/assets/static/js/pages/dashboard.js") }}"></script>
